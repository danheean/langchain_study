...
- run: streamlit run chatbot_langchain_file_hf_chroma_openai_rag02.py --server.port 8001
"""
import os
...
if uploaded_file :
    ...
    chain = ConversationalRetrievalChain.from_llm(llm = ChatOpenAI(model_name='gpt-4o', temperature=0.0), retriever=vectors.as_retriever())
